  ...
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-6">
              ...
              <Card className="bg-primary-50">
                ...
                <PrimaryButton fullWidth onClick={() => setShowApplicationForm(true)}>
                  Apply to Volunteer
                </PrimaryButton>
              </Card>
        ...
        {/* Application Form Modal - Simple placeholder */}
        {showApplicationForm && (
          <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
            ...
            >
              <h2 className="text-2xl font-bold text-secondary mb-4">Apply for {opportunity.title}</h2>
              <p className="text-secondary-700 mb-6">
                Fill out this form and our team will get back to you within 5-7 days.
              </p>
              
              {/* TODO: Add full application form here */}
              <p className="text-center text-secondary-500 py-8">
                Application form coming soon...
              </p>

              <div className="flex gap-4">
                <SecondaryButton fullWidth onClick={() => setShowApplicationForm(false)}>
                  Close
                </SecondaryButton>
